all: red_test libafosr_cfd.so libafosr_cfd_cuda_core.so libafosr_cfd_opencl_core.so

red_test: libafosr_cfd.so libafosr_cfd_opencl_core.so
	gcc red_bootstrapper.c -I ./ -D WITH_CUDA -D WITH_OPENCL -L ./ -lafosr_cfd -lafosr_cfd_opencl_core -lafosr_cfd_cuda_core -o red_test
