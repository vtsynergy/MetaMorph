 ...
 * \param accel Address in which to return the currently-active device's ID
 ...
 * \param block_y Number of desired threads within each block in the Y dimension
 * \param block_z Number of desired threads within each block in the Z dimension
 * \param data1 The left matrix in the dot product operator, a
 * Metamorph-allocated buffer on the current device
 * \param data2 The right matrix in the dot product operator, a
 * Metamorph-allocated buffer on the current device
 ...
 * \param start_x Index in data1 and data2 of the first element in the X
 * dimension
 * \param start_y Index in data1 and data2 of the first element in the Y
 * dimension
 * \param start_z Index in data1 and data2 of the first element in the Z
 * dimension
 ...
 * \param reduction_var The final scalar dot product value, a
 * Metamorph-allocated buffer on the current device
 ...
 * \param block_y Number of desired threads within each block in the Y dimension
 * \param block_z Number of desired threads within each block in the Z dimension
 * \param data The matrix to perform sum reduction on, a Metamorph-allocated
 ...
 * \param reduction_var The final scalar reduction value, a Metamorph-allocated
 * buffer on the current device
 * \param type The MetaMorph data type to interpret the data arrays as
 * \param async Whether the kernel should be run asynchronously or blocking
 ...
 * \param dst The destination, a MetaMorph-allocated handle on the
 ...
 * \param src The source, a MetaMorph-allocated handle on the currently-active
 * device
